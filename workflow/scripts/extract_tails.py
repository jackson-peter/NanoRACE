...
@click.option('--summary', help='Input sequencing_summary.txt generated by basecalling software. ', required=True, type=click.Path(exists=True))
...
def get_three_primes_parts_row(row, constant_seq, umi_seq, adapt_seq, debug):
    ...
    try:
        ...
        return pd.Series([np.nan, np.nan, np.nan,np.nan , np.nan, np.nan, np.nan, "no coords", f"{e} occurred"])
    ...
    if debug:
        print("")
        print("###########")
        print(row['read_core_id'], primer_type)
        ...
        print(polytail_start_in_read, polytail_end_in_read)
        print(polytail)
        print(len(polytail))
        print("additional_tail")
        print(additional_tail_start_in_read, additional_tail_end_in_read)
        print(additional_tail)
        print("delimiter")
        print(delimiter)
        print(delimiter=="")
